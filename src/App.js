  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/admin/manage-languages" element={<AdminRoute><SchoolMediumManage /></AdminRoute>} />
        ...
        <Route path="/admin/create-language" element={<AdminRoute><CreateSchoolMedium /></AdminRoute>} />
