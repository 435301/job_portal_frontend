...
export const getAllCourses = createAsyncThunk<any, { page?: number; showStatus?: string | number; search?: string, educationId?:number; } | void>(
    "course/getAll",
    async (params = { page: 1, showStatus: 1, search: "", educationId:0 }, { rejectWithValue }) => {
        try {
