...
import SkillViewModal from "../componets/Modal/SkillViewModal.tsx";
import SkillEditModal from "../componets/Modal/SkillEditModal.tsx";
...
function SkillManage() {
    ...
    const [skillDelete, setSkillDelete] = useState<number | null>(null);
    ...
    useEffect(() => {
        dispatch(getAllSkills({ page, search: searchTerm, showStatus: statusFilter }));
    ...
    const handleSaveEdit = (updatedItem: Skill) => {
        dispatch(updateSkill({ id: updatedItem.id, updateData: updatedItem }));
        setShowEdit(false);
    };
    ...
    const handleDelete = async () => {
        if (skillDelete !== null) {
            await dispatch(deleteSkill(skillDelete));
                            ...
                            <Row className="align-items-center">
                                ...
                                <Col xs="auto">
                                    <Button
                                        ...
                                        onClick={() => navigate("/admin/create-skill")}
                                    >
                        ...
                        <Card className="shadow-sm border-0">
                            <Card.Header className="bg-white py-3 d-flex justify-content-between align-items-center">
                                <h6 className="fw-bold mb-0 text-primary">
                                    <i className="bi bi-list-task me-2"></i>Skill List
                                </h6>
                                <span className="text-muted small">
                                    Showing {skillList?.length || 0} results
                                </span>
                            </Card.Header>
                            ...
                            <Card.Body className="p-0">
                                {loading ? (
                                    ...
                                    <Table responsive hover className="mb-0 align-middle">
                                        ...
                                        <tbody>
                                            {skillList?.length > 0 ? (
                                                skillList.map((item: Skill, index: number) => (
                                                    <tr key={item.id}>
                                                        <td>{index + 1}</td>
