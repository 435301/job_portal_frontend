...
import { deleteCountry, getAllCountry, updateCountry } from "../../redux/slices/countrySlice.tsx";
import CountryViewModal from "../componets/Modal/CountryViewModal.tsx";
import CountryEditModal from "../componets/Modal/CountryEditModal.tsx";
...
function CountryManage() {
    ...
    const [countryDelete, setCountryDelete] = useState<number | null>(null);
    ...
    useEffect(() => {
        dispatch(getAllCountry({ page, search: searchTerm, status: statusFilter ,}));
    ...
    const handleReset = () => {
        ...
        setStatusFilter("");
        setPage(1);
        dispatch(getAllCountry({ page: 1, search: "", status: "" ,}));
    };
    ...
    const handleSaveEdit = (updatedItem: Country) => {
        dispatch(updateCountry({ id: updatedItem.id, updateData: updatedItem }));
        setShowEdit(false);
    };
    ...
    const handleDelete = async () => {
        if (countryDelete !== null) {
            await dispatch(deleteCountry(countryDelete));
                        ...
                        <Card className="p-3 border-0 card-header shadow-sm mb-2">
                            <Row className="align-items-center">
                                ...
                                <Col xs="auto">
                                    ...
                                    >
                                        <i className="bi bi-plus-circle me-2"></i>Add Country
                                    </Button>
                                </Col>
                            </Row>
                        </Card>
                        ...
                        <Card className="shadow-sm border-0">
                            <Card.Header className="bg-white py-3 d-flex justify-content-between align-items-center">
                                <h6 className="fw-bold mb-0 text-primary">
                                    <i className="bi bi-list-task me-2"></i>Country List
                                </h6>
                                <span className="text-muted small">
                                    Showing {countryList?.length || 0} results
                                </span>
                            </Card.Header>
