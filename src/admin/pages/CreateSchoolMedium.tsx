...
import { FormErrors, validateSchoolMediumForm, } from "../../common/validation.tsx";
import { useSelector } from "react-redux";
import { RootState } from "../../redux/store.tsx";
import { getUserIpAddress } from "../../common/ipAddress.tsx";
import { createSchoolMedium } from "../../redux/slices/schoolMediumSlice.tsx";

interface SchoolMediumForm {
    schoolMedium: string;
    status: number | any;
    ipAddress: string;
}

function CreateSchoolMedium() {
    ...
    const [formData, setFormData] = useState<SchoolMediumForm>({
        schoolMedium: "",
        status: "",
        ipAddress: "",
    });
    ...
    const handleSubmit = async (e: FormEvent) => {
        e.preventDefault();
        const validationErrors = validateSchoolMediumForm(formData);
                                ...
                                <Row className="g-3">
                                     ...
                                     <Col md={4}>
                                            <Form.Group>
                                                ...
                                                />
                                                {errors.schoolMedium && (
                                                    <div className="invalid-feedback">{errors.schoolMedium}</div>
                                                )}
                                            </Form.Group>
                                        </Col>
                                    <Col md={4}>
...
export default CreateSchoolMedium;
