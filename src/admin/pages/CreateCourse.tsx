...
import { FormErrors, validateCourseForm } from "../../common/validation.tsx";
...
function CreateCourse() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const resultAction = await dispatch(createCourse(finalData));
                        ...
                        <Card className="p-3 border-0 card-header shadow-sm mb-3">
                            <Row className="align-items-center">
                                ...
                                <Col xs="auto">
                                    ...
                                    >
                                        <i className="bi bi-arrow-left me-2"></i>Manage Course
                                    </Button>
                                </Col>
                            </Row>
                        </Card>
