...
import { FormErrors, validateCountryForm, } from "../../common/validation.tsx";
import { useSelector } from "react-redux";
import { RootState } from "../../redux/store.tsx";
import { getUserIpAddress } from "../../common/ipAddress.tsx";
import { createCountry } from "../../redux/slices/countrySlice.tsx";
...
function CreateCountry() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        e.preventDefault();
        const validationErrors = validateCountryForm(formData);
        ...
        try {
            const resultAction = await dispatch(createCountry(finalData));
            if (createCountry.fulfilled.match(resultAction)) {
                navigate("/admin/manage-Country");
            }
        } catch (error) {
            console.log(error)
        }
                            ...
                            <Row className="align-items-center">
                                ...
                                <Col xs="auto">
                                    <Button
                                        ...
                                        onClick={() => navigate("/admin/manage-country")}
                                    >
                                        <i className="bi bi-arrow-left me-2"></i>Manage Country
                                    </Button>
                                </Col>
                            </Row>
                        </Card>
