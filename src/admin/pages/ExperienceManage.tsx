...
import { deleteExperience, getAllExperiences, updateExperience } from "../../redux/slices/experienceSlice.tsx";
import ExperienceViewModal from "../componets/Modal/ExperienceViewModal.tsx";
import ExperienceEditModal from "../componets/Modal/ExperienceEditModal.tsx";
...
function ExperienceManage() {
    ...
    const { experienceList, loading } = useSelector(
    ...
    const [experienceDelete, setExperienceDelete] = useState<number | null>(null);
    ...
    useEffect(() => {
        dispatch(getAllExperiences({ page, search: searchTerm, showStatus: statusFilter === "" ? undefined : Number(statusFilter), }));
    ...
    const handleReset = () => {
        ...
        setStatusFilter("");
        setPage(1);
        dispatch(getAllExperiences({ page: 1 }));
    };

    const handleView = (item: Experience) => {
    ...
    const handleSaveEdit = (updatedItem: Experience) => {
        dispatch(updateExperience({ id: updatedItem.id, updateData: updatedItem }));
        setShowEdit(false);
    };

    const handleDeleteClick = (id: any) => {
        setExperienceDelete(id);
        setShowDeleteModal(true);
    };

    const handleDelete = async () => {
        if (experienceDelete !== null) {
            await dispatch(deleteExperience(experienceDelete));
                            ...
                            <Row className="align-items-center">
                                ...
                                <Col xs="auto">
                                    <Button
                                        ...
                                        onClick={() => navigate("/admin/create-experience")}
                                    >
                        ...
                        <Card className="shadow-sm border-0">
                            <Card.Header className="bg-white py-3 d-flex justify-content-between align-items-center">
                                <h6 className="fw-bold mb-0 text-primary">
                                    <i className="bi bi-list-task me-2"></i>Experience List
                                </h6>
                                <span className="text-muted small">
                                    Showing {experienceList?.length || 0} results
                                </span>
                            </Card.Header>
