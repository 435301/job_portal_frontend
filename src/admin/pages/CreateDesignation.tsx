...
import { createDesignation } from "../../redux/slices/DesignationSlice.tsx";
import { FormErrors, validateDesignationForm } from "../../common/validation.tsx";
...
function CreateDesignation() {
    ...
    const [formData, setFormData] = useState<DesignationForm>({
        designation: "",
        status: "",
        ipAddress: "",
    });
    ...
    const handleSubmit = async (e: FormEvent) => {
        e.preventDefault();
        const validationErrors = validateDesignationForm(formData);
        ...
        try {
            const resultAction = await dispatch(createDesignation(finalData));
            if (createDesignation.fulfilled.match(resultAction)) {
                navigate("/admin/manage-designation");
            }
        } catch (error) {
            console.log(error)
        }
                            ...
                            <Row className="align-items-center">
                                ...
                                <Col xs="auto">
                                    <Button
                                        ...
                                        onClick={() => navigate("/admin/manage-designation")}
                                    >
                                        <i className="bi bi-arrow-left me-2"></i>Manage Designation
                                    </Button>
                                </Col>
                            </Row>
                        </Card>
