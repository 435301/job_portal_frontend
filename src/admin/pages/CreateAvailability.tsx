...
import { FormErrors, validateAvailabilityForm, } from "../../common/validation.tsx";
import { useSelector } from "react-redux";
import { RootState } from "../../redux/store.tsx";
import { getUserIpAddress } from "../../common/ipAddress.tsx";
import { createAvailability } from "../../redux/slices/availabilitySlice.tsx";
...
function CreateAvailability() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const resultAction = await dispatch(createAvailability(finalData));
            if (createAvailability.fulfilled.match(resultAction)) {
                navigate("/admin/manage-availability");
            }
        } catch (error) {
            console.log(error)
        }
                            ...
                            <Row className="align-items-center">
                                ...
                                <Col xs="auto">
                                    <Button
                                        ...
                                        onClick={() => navigate("/admin/manage-availability")}
                                    >
                                        <i className="bi bi-arrow-left me-2"></i>Manage Availability
                                    </Button>
                                </Col>
                            </Row>
                        </Card>
