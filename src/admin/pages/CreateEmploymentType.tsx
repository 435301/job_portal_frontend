...
import { FormErrors, validateEmploymentTypeForm } from "../../common/validation.tsx";
import { useSelector } from "react-redux";
import { RootState } from "../../redux/store.tsx";
import { getUserIpAddress } from "../../common/ipAddress.tsx";
import { createEmploymentType } from "../../redux/slices/employementTypeSlice.tsx";
...
function CreateEmploymentType() {
    ...
    const [formData, setFormData] = useState<EmploymentTypeForm>({
        employmentType: "",
        status: "",
        ipAddress: "",
    });
    ...
    const handleSubmit = async (e: FormEvent) => {
        e.preventDefault();
        const validationErrors = validateEmploymentTypeForm(formData);
        ...
        try {
            const resultAction = await dispatch(createEmploymentType(finalData));
            if (createEmploymentType.fulfilled.match(resultAction)) {
                navigate("/admin/manage-employment-type");
            }
        } catch (error) {
            console.log(error)
        }
                        ...
                        <Card className="p-3 border-0 card-header shadow-sm mb-3">
                            <Row className="align-items-center">
                                ...
                                <Col xs="auto">
                                    ...
                                    >
                                        <i className="bi bi-arrow-left me-2"></i>Manage Employment Type
                                    </Button>
                                </Col>
                            </Row>
                        </Card>
