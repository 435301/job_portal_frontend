...
const DesignationViewModal: React.FC<DesignationViewModalProps> = ({ show, onHide, item }) => {
  if (!item) return null;
  ...
  return (
    ...
    >
      <Modal.Header closeButton className="bg-light text-white">
        <Modal.Title>
          <i className="bi bi-eye me-2"></i>View Designation
        </Modal.Title>
      </Modal.Header>
...
export default DesignationViewModal;
